...
def downsample_phases(input_dir, output_dir, n_phases=25, order=3, prefix=""):
    ...
    print(f"[downsample_phases] {input_dir} -> {output_dir}  prefix='{prefix}'")
    ...
    for fname in [f"{prefix}b0.nii.gz"]:
